...
//
//import com.esp.util.SecuritySolveUtil;
//import com.yonyou.yzt.common.exception.GlobalException;
...
//            throw new BizCodeEnum(e.getMessage());
//        } catch (IOException e) {
...
//            return new MyBufferedInputStream(httpURLConnection, httpURLConnection.getInputStream());
//        } catch (Exception e) {
//            log.error(e.getMessage(), e);
//            throw new GlobalException(e);
//        }
...
//    /**
//     * @author lihong
//     * 用于将通过TCP请求拿到的流，传递到其他类中使用的场景。使用处关闭流，同时关闭链接
//     */
//    private static class MyBufferedInputStream extends  BufferedInputStream {
//
//        private HttpURLConnection httpURLConnection;
//
//        public MyBufferedInputStream(HttpURLConnection httpURLConnection, InputStream inputStream) {
//            super(inputStream);
//            this.httpURLConnection = httpURLConnection;
//        }
//
//        public MyBufferedInputStream(HttpURLConnection httpURLConnection, InputStream inputStream, int size) {
...
//                log.error("文件权限设置失败!!! -->{}", SecuritySolveUtil.logForging(path.toString()));
////            } else {
